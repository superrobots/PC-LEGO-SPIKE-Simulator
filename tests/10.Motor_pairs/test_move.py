...
def test_move():
    ...
    # Move the motor pair 10 cm forward at full speed with no steering
    motor_pair.move(10, 'cm', steering=0, speed=100)

    # Move the motor pair 5 rotations backward at half speed with left steering
    motor_pair.move(-5, 'rotations', steering=-50, speed=-50)

    # Move the motor pair 90 degrees in place at quarter speed with right steering
    motor_pair.move(90, 'degrees', steering=50, speed=25)
