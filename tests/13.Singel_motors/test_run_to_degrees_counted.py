...
def test_run_to_degrees_counted():
    '''
    Test the run_to_degrees_counted method of the Motor class.
    This test will move the motor to specific degrees and wait for 1 second between movements.
    '''
