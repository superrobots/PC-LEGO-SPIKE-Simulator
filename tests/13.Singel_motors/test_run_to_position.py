...
def test_run_to_position():
    ...
    # Run the motor to position "150" in clockwise direction
    motor.run_to_position(150, 'clockwise')
    time.sleep(3)

    # Run the motor to position "250" in clockwise direction
    motor.run_to_position(250, 'clockwise')
    time.sleep(3)

    # Run the motor to position "350" in clockwise direction
