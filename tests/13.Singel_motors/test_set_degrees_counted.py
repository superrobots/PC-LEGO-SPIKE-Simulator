...
def test_set_degrees_counted():
    """Test set_degrees_counted"""
    motor = Motor('A')
    motor.set_degrees_counted(10)
    assert motor.get_degrees_counted() == 10, "set_degrees_counted failed to set the degrees counted correctly"
