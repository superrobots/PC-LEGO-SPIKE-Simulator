...
class ColorSensor:
    ...
    def __init__(self, port):
        ...
        if self.ISDEBUG:
            print(
                "Color sensor is initialised in debug mode. Simulation:True Color sensor simulator type:",
                self.SIMULATORTYPE,
                " change at spike.color_sensor.py ",
            )

    def get_ambient_light(self):
        if self.ISDEBUG:
            print(
                "Color sensor get_ambient_light() Retrieves the intensity of the ambient light."
            )
        self.ambient_light, self.ambient_light_direction = self.simulator.get_new_value(
            issimulation=True,
    ...
    def get_blue(self):
        if self.ISDEBUG:
            print("Color sensor get_blue() Retrieves the color intensity of blue.")
        self.blue, self.blue_direction = self.simulator.get_new_value(
            issimulation=True,
            simulationtype=self.SIMULATORTYPE,
            isdebug=self.ISDEBUG,
    ...
    def get_green(self):
        if self.ISDEBUG:
            print("Color sensor get_green() Retrieves the color intensity of green.")
        self.green, self.green_direction = self.simulator.get_new_value(
            issimulation=True,
            simulationtype=self.SIMULATORTYPE,
            isdebug=self.ISDEBUG,
    ...
    def get_red(self):
        if self.ISDEBUG:
            print("Color sensor get_red() Retrieves the color intensity of red.")
        self.red, self.red_direction = self.simulator.get_new_value(
            issimulation=True,
            simulationtype=self.SIMULATORTYPE,
            isdebug=self.ISDEBUG,
    ...
    def get_color(self):
        if self.ISDEBUG:
            print("Color sensor get_color() Retrieves the detected color of a surface.")
        self.color_index, self.color_index_direction = self.simulator.get_new_value(
            issimulation=True,
            simulationtype=self.SIMULATORTYPE,
            isdebug=self.ISDEBUG,
    ...
    def get_reflected_light(self):
        if self.ISDEBUG:
            print(
                "Color sensor get_reflected_light() Retrieves the intensity of the reflected light."
            )
        # self.reflected_light = 0 #0..100
        self.reflected_light, self.reflected_light_direction = (
    ...
    def get_rgb_intensity(self):
        ...
        if self.ISDEBUG:
            print(
                "Color sensor get_rgb_intensity() Retrieves the overall color intensity, and intensity of rgb_intensity, green, and blue."
            )
        self.rgb_intensity, self.rgb_intensity_direction = self.simulator.get_new_value(
            issimulation=True,
            simulationtype=self.SIMULATORTYPE,
            isdebug=self.ISDEBUG,
    ...
    def light_up(self, light_1, light_2, light_3):
        if self.ISDEBUG:
            print(
                "Color sensor light_up() Sets the brightness of the individual lights on the Color Sensor. light_1:",
                str(light_1),
                ", light_2:",
                str(light_2),
                ", light_3:",
        ...
        print(
            "Simulated color sensor light up by: light_1:",
            light_1,
            " light_2:",
            light_2,
            " light_3:",
    ...
    def light_up_all(self, brightness=100):
        if self.ISDEBUG:
            print(
                "Color sensor light_up_all() Lights up all of the lights on the Color Sensor at the specified brightness. brightness:",
                str(brightness),
            )
    ...
    def wait_for_new_color(self):
        if self.ISDEBUG:
            print(
                "Color sensor wait_for_new_color() Waits until the Color Sensor detects a new color. Color at start:",
                self.colors_array[self.color_index],
            )
        runwhile = True
        while runwhile:
    ...
    def wait_until_color(self, color):
        ...
        if self.ISDEBUG:
            print(
                "Color sensor wait_until_color() Waits until the Color Sensor detects the specified color."
            )
        runwhile = True
        while runwhile:
            self.color_index, self.color_index_direction = self.simulator.get_new_value(
            ...
            if self.ISDEBUG:
                print(
                    "Do changes at color sensor new reading:",
                    str(self.color_index),
                    " to exit it should be higher or equal then:",
                    old_color_index,
                    " or it should be lower or equal then:",
                    old_color_index,
                )
